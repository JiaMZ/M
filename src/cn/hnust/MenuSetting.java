...
public class MenuSetting {
	...
	public static String appId = "wx9b8385fec1ea3ca7";
    public static String appSecret= "124843cb79934a38983482bf0acecd27"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://6i2ddd.natappfree.cc/Weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
